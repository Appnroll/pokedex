...
object DependenciesJetpack {
    ...
    const val androidxCoreLib = "androidx.core:core:${VersionsJetpack.androidxCore}"
    ...
    const val archNavigationFragmentLib = "android.arch.navigation:navigation-fragment:${VersionsJetpack.archNavigation}"
    const val archNavigationUiLib = "android.arch.navigation:navigation-ui:${VersionsJetpack.archNavigation}"
